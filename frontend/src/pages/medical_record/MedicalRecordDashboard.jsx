    ...
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-[#E2E8F0] p-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <Link to="/medical-record/history" className="text-[#001bca] text-xs font-semibold hover:underline">View All</Link>
        </div>
        <div className="space-y-3">
          {data.recent.length === 0 && <p className="text-sm text-[#64748B]">No submissions yet.</p>}
          {data.recent.map((c) => (
            <div key={c.id} className="flex items-center justify-between p-4 bg-[#f2f4f6] rounded-lg">
              <div>
