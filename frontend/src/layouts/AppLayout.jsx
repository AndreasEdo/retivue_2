...
export default function AppLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f7f9fb] dark:bg-[#0a0f1e] transition-colors duration-300">
      ...
      >
        {/* Top Bar */}
        <header className="bg-white dark:bg-[#0f172a] border-b border-[#e2e8f0] dark:border-white/10 shadow-sm h-14 px-6 flex items-center justify-between sticky top-0 z-40 transition-colors duration-300">
        ...
        <div key={location.pathname} className="p-6 page-transition">
          <Outlet />
        </div>
      </main>
    </div>
